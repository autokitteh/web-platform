...
export default defineConfig({
	...
	define: {
		...
		"import.meta.env.FF_DISPLAY_DISCORD_INTEGRATION": process.env.FF_DISPLAY_DISCORD_INTEGRATION,
		"import.meta.env.FF_DISPLAY_SLACK_SOCKET_INTEGRATION": process.env.FF_DISPLAY_SLACK_SOCKET_INTEGRATION,
