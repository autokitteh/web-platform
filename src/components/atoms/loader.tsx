...
export const Loader = ({ size = "xl", firstColor = "red", secondColor = "green" }: LoaderProps) => {
	console.log("size", size);
	const sizeClass = cn("loader-cycle-disks before:content-loader-cycle-disks after:content-loader-cycle-disks", {
