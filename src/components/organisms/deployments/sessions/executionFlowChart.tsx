...
export const ExecutionFlowChart = ({ activities }: { activities: any[] }) => {
	...
	// Use useEffect to initialize chart listeners after chart renders
	React.useEffect(() => {
	...
	const loadActivities = async () => {
		...
		try {
			...
			const finalActivities = activities.reverse();
			...
			const seriesData = activities.map((activity, index) => {
