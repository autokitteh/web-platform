...
export const DiscordIntegrationAddForm = ({
	...
	const { createConnection, errors, isLoading, register } = useConnectionForm(
		{ botToken: "" },
	...
	useEffect(() => {
		if (connectionId) {
			createConnection(connectionId, ConnectionAuthType.DiscordBotToken, Integrations.discord);
		}
