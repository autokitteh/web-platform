				...
				<Table className="mt-3">
					<THead>
						<Tr>
							...
							<Th className="cursor-pointer font-normal group" onClick={() => requestSort("connectionName")}>
							...
							<Tr className="group" key={trigger.triggerId}>
								<Td className="font-semibold">
									<div className="flex gap-3">
										{trigger.data?.schedule?.string?.v ? <ClockIcon className="fill-white w-4" /> : null} {trigger.name}
									</div>
								</Td>
