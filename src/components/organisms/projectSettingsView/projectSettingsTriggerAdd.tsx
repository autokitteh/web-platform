		...
		<div className="mx-auto flex size-full flex-col gap-2 overflow-y-auto p-6">
			<div className="mb-4 flex items-center justify-between">
				<div className="flex items-center gap-3">
					...
					<h2 className="text-2xl font-semibold text-white">{t("addNewTrigger")}</h2>
				</div>
			</div>
			...
			<div className="flex flex-col gap-4">
				<p className="text-gray-400">Trigger add functionality will be implemented here.</p>
				<p className="text-gray-400">This is a placeholder for the full trigger add form.</p>
			</div>
