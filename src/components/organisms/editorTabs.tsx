...
import { CodeFixSuggestionType, MessageTypes } from "@src/types";
...
export const EditorTabs = () => {
	...
	}, [editorMounted, projectId, activeEditorFileName, currentProject, content, handleEditorFocus]);
	...
	const handleCloseCodeFixModal = useCallback(
		...
		[codeFixData, closeModal, tErrors]
	);
