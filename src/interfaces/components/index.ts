...
export type { ITabTrigger } from "@interfaces/components/tabsTrigger.interface";
...
export type { IModal, IModalAddCodeAssets } from "@interfaces/components/modal.interface";
